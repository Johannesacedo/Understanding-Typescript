...
console.log(pers);
//Decorator factories Sample
//Adding multiple decorator factories
function DecoratorfactoriesSample(logString) {
...
let decoratorFactories = class decoratorFactories {
    constructor() {
        this.name = 'Max';
        console.log('Creating person object...');
    }
};
decoratorFactories = __decorate([
    DecoratorfactoriesSample('Logging-person'),
    WithTemplate('<h1>Hello world!</h1>', 'app')
], decoratorFactories);
const decorate = new decoratorFactories();
console.log(decorate);
//end of Decorator factories Sample
...
//end of diving into property decorators
...
//end of validation with decorators
